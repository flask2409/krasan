...
class Pest(models.Model):
	...
	image = models.FileField(upload_to='media/pest/price', verbose_name="Изображение", blank=True)
	file = models.FileField(upload_to='media/pest/price', verbose_name="Прайс лист", blank=True)
